...
class IssueService(
    ...
    fun get(id : Long) : IssueResponse {
        val issue = issueRepository.findByIdOrNull(id) ?: throw NotFountException("이슈가 존재하지 않습니다")
    ...
    fun edit(userId: Long, id: Long, request: IssueRequest) : IssueResponse {
        ...
        val issue : Issue = issueRepository.findByIdOrNull(id) ?: throw NotFountException("이슈가 존재하지 않습니다")
